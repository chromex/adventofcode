lines = """Game 1: 1 green, 6 red, 4 blue; 2 blue, 6 green, 7 red; 3 red, 4 blue, 6 green; 3 green; 3 blue, 2 green, 1 red
...
Game 100: 3 blue, 6 red, 9 green; 4 red, 3 green; 4 green, 16 red, 1 blue; 14 blue, 1 green""".splitlines()
...
for idx, line in enumerate(lines):
    ...
    maxC = [0,0,0]
    for pull in pulls:
        maxC = aoc.Pairwise(max, maxC, ParsePull(pull))
